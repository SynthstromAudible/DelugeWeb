import $ from'jquery';
import WaveSurfer from './js/ws/wavesurfer.js';
import TimelinePlugin from'./js/ws/plugins/timeline.js';
import RegionPlugin  from'./js/ws/plugins/regions.js';
import Minimap from'./js/ws/plugins/minimap.js';
import {TiledRenderer, tiledDrawBuffer} from './js/ws/plugins/tiledrenderer.js';
