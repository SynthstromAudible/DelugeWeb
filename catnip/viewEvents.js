...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/viewEvents.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/*!***************************!*\
  !*** ./src/mididriver.js ***!
  \***************************/
/*! exports provided: sysExRunning, setSysExCallback */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sysExRunning", function() { return sysExRunning; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setSysExCallback", function() { return setSysExCallback; });
...
/* harmony import */ var _mididriver_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mididriver.js */ "./src/mididriver.js");
...
// 	let runx = parseInt(ps.substring(cursor + 8, cursor + 16), 16);
  ...
  render() {
    ...
    plot.css("width", maxWidth + "px");
		...
		*/
		if (!_mididriver_js__WEBPACK_IMPORTED_MODULE_2__["sysExRunning"]) activateTippy();
...
{
	if (!activeView) return;
	if (!_mididriver_js__WEBPACK_IMPORTED_MODULE_2__["sysExRunning"] && !tippyActive) {
		activateTippy();
	}
...
Object(_mididriver_js__WEBPACK_IMPORTED_MODULE_2__["setSysExCallback"])(sysExCallback);
setRefresh();
