...
const quaddropdn = Handlebars.compile(`<button id='quadpop' class="dropbtn">Lowpass Filter </button>
...
const sfx_dropdn_template = Handlebars.compile(`<button class="dropbtn">Effects </button>
	<div class="dropdown-content">
...
const delay_template = Handlebars.compile(`<div class='delay'>
<table>
<tr>
...
const osc_template = Handlebars.compile(`<div class='osc'>
<table>
<tr>
...
const buttonrow = Handlebars.compile(`<button class="butn zoominbut" title='Zoom in'><img src='img/glyphicons-237-zoom-in.png'/></button>
<button class="butn zoomselbut" title='Zoom to'><img src='img/glyphicons-zoom-sel.png'/></button>
...
<button class='butn playbut' title='Play'><img width='16px'height='18px' class='playbutimg' src='img/glyphicons-174-play.png'/></button>
<button class='butn playselbut' title='Play selected'><img src='img/glyphicons-221-play-button.png'/></button>
...
`);
Handlebars.registerPartial('buttonrow', buttonrow);

const filegroup_template = Handlebars.compile(`<div id='wavegroup{{idsuffix}}'>
...
const filter_frame_template = Handlebars.compile(`<div class='filterhdr'>
<table><tr>
...
const quadfilter_template = Handlebars.compile(`<div id='quadfilter'>
<table>
<tr>
...
const reverb_template = Handlebars.compile(`<div class='simplereverb'>
<table>
<tr>
...
export {quaddropdn, sfx_dropdn_template, delay_template, buttonrow, osc_template, filegroup_template, filter_frame_template, quadfilter_template, reverb_template}
